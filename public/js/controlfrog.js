...
function createSparkline(obj, data, mean){
	...
	cf_defaultSparkOpts.minSpotColor = true;
	...
	let sparkOptions = cf_defaultSparkOpts;
	...
	function generateSparkline(){
		...
		// Current value
		$('.sparkline-value .metric-small', $parent).html("Ø" + mean);
...
$(document).ready(function(){
	...
	*/								
	$('.cf-rag').each(function(){
		// Dummy data for RAG
		ragData = [0,100,0];
		ragLabels = ['Chyby','long-polling fallback','Secure WebSockets'];
		ragOpts = {}
